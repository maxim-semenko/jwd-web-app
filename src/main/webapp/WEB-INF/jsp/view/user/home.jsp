    ...
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <div class="form-signin">
                <form class="needs-validation" action="controller?command=sign-in" method="post">
                ...
                <a href="controller?command=sign-up" style="text-decoration: none">
                    <button class="btn btn-lg btn-primary btn-block" type="submit"
                            id="btn_signup"><fmt:message key="home.button.signup"/>
                    </button>
                </a>
                <br>
                <a href="controller?command=forgot-password"><fmt:message key="home.forgotPassword"/></a>
            </div>
        </div>
    </section>
