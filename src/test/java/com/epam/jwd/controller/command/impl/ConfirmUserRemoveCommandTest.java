...
public class ConfirmUserRemoveCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        command = CommandFactory.getCommand(CommandType.CONFIRM_USER_REMOVE_PAGE.getUrl());
    }

    @Test
    public void testExecute() {
        final ResponseContext responseContext = command.execute(new CustomRequestContext(req));
        Assert.assertEquals(responseContext.getPage(), PathToPages.CONFIRM_USER_REMOVE_PAGE);
    }
}