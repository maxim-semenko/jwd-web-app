...
public class ForgotPasswordPageCommandTest {
    ...
    public void setUp() {
        ...
        command = CommandFactory.getCommand("forgot-password");
    }

    @Test
    public void testExecute() {
        final ResponseContext responseContext = command.execute(new CustomRequestContext(req));
        Assert.assertEquals(responseContext.getPage(), PathToPages.FORGOT_PASSWORD_PAGE);
    }
}