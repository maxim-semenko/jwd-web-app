...
public class UserCabinetCommandTest {
    ...
    public void setUp() {
        ...
        command = CommandFactory.getCommand("cabinet");
    }

    @Test
    public void testExecuteThatReturnUserCabinetPage() {
        final ResponseContext responseContext = command.execute(new CustomRequestContext(req));
        Assert.assertEquals(responseContext.getPage(), PathToPages.USER_CABINET_PAGE);
    }
}